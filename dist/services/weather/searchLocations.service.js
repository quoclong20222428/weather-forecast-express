 ...
 */
export async function searchLocationsFullText(searchTerm, limit = 8) {
 ...
 */
export async function searchLocationsByPrefix(prefix, limit = 10) {
 ...
 */
export async function searchLocationsHybrid(searchTerm, limit = 20) {
    const cleanedTerm = searchTerm.trim();
 ...
 */
async function fallbackSearch(searchTerm, limit) {
    try {
        const results = await prisma.$queryRaw `
            SELECT 
                id,
